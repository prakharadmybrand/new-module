...
type App struct {
	*baseapp.BaseApp
	...
	MymoduleKeeper mymodulemodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.MymoduleKeeper = *mymodulemodulekeeper.NewKeeper(
		appCodec,
		keys[mymodulemoduletypes.StoreKey],
		keys[mymodulemoduletypes.MemStoreKey],
		app.GetSubspace(mymodulemoduletypes.ModuleName),
	)
	mymoduleModule := mymodulemodule.NewAppModule(appCodec, app.MymoduleKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		mymodulemoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(mymodulemoduletypes.ModuleName)
